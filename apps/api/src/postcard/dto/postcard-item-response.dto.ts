...
import { PostcardReactionResponseDto } from './postcard-reaction-response.dto';

export class PostcardItemResponseDto {
  ...
  @ApiProperty({ type: [PostcardReactionResponseDto] })
  reactionCounts!: PostcardReactionResponseDto[];
